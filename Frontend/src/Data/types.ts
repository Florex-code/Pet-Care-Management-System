...
export type Adoption = { id: string; name: string; species: string; breed: string; age: string; photo?: string; status: "Available" | "Pending" | "Adopted"; applicantId?: string; applicantName?: string; requestMessage?: string };
